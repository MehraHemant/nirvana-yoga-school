...
const migrationId = "0003_ai_chat";
const migrationPath = resolve(process.cwd(), "scripts/sql/0003_ai_chat.sql");
...
/**
 * Applies the AI chat schema migration once via `_app_migrations`.
 */
