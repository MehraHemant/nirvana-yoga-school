...
export const PAGE_LAYOUTS: Record<PageLayoutId, PageLayoutDefinition> = {
  ...
  yttHub: {
    ...
    sections: [
      ...
      {
        id: "video",
        label: "Videos (home playlist)",
        source: "link",
        linkHref: "/admin/pages/home",
      },
      {
        id: "gallery",
        label: "Photos (home gallery)",
        source: "link",
        linkHref: "/admin/pages/home",
      },
      {
        id: "why-rishikesh",
        label: "Yoga teacher training in Rishikesh",
        source: "globalSettings",
        settingsKey: "yttHub",
      },
      {
      ...
      {
        id: "eligibility",
        label: "Eligibility & Certification",
        source: "globalSettings",
        settingsKey: "yttHub",
      },
      {
      ...
      {
        id: "reviews",
        label: "Review (home testimonials)",
        source: "link",
        linkHref: "/admin/pages/home",
      },
      SHARED_LINK("siteMap", "Map (shared)"),
