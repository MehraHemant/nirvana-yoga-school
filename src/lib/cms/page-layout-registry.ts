...
export const PAGE_LAYOUTS: Record<PageLayoutId, PageLayoutDefinition> = {
  ...
  residentialCourse: {
    ...
    sections: [
      ...
      SHARED_LINK("residentialLife", "Accommodation & food (shared)"),
      { id: "pricing", label: "Pricing", source: "pageModules" },
      SHARED_LINK("whyNirvana", "Why Nirvana (shared)"),
      SHARED_LINK("siteMap", "Map (shared)"),
      { id: "travel", label: "Travel (visibility)", source: "pageModules" },
      { id: "instagram", label: "Instagram (visibility)", source: "pageModules" },
  ...
  retreat: {
    ...
    sections: [
      ...
      SHARED_LINK("retreatAccommodation", "Accommodation & food (shared)"),
      { id: "packages", label: "Packages & dates", source: "courseDocument" },
      SHARED_LINK("reviews", "Testimonials"),
      SHARED_LINK("siteMap", "Map (shared)"),
      { id: "faq", label: "FAQ", source: "courseDocument" },
    ],
  },
  venue: {
    ...
    sections: [
      ...
      SHARED_LINK("whyNirvana", "Why Nirvana (shared)"),
      SHARED_LINK("siteMap", "Map (shared)"),
      SHARED_LINK("venueFaqs", "Venue FAQs (shared)"),
      { id: "map", label: "Map (visibility)", source: "pageModules" },
    ],
  },
  yttHub: {
  ...
  hub: {
    ...
    sections: [
      ...
      { id: "gallery", label: "Gallery", source: "contentData" },
      { id: "editorial", label: "Editorial", source: "contentData" },
      SHARED_LINK("residentialLife", "Accommodation & food"),
      SHARED_LINK("whyNirvana", "Why Nirvana"),
      SHARED_LINK("siteMap", "Map (shared)"),
      { id: "travel", label: "Travel (visibility)", source: "pageModules" },
      { id: "instagram", label: "Instagram (visibility)", source: "pageModules" },
      { id: "faq", label: "FAQ", source: "pageModules" },
...
/**
 * Shared-section deep-links for a layout (Why Nirvana, lodging, map, etc.).
 *
...
export function sharedSectionLinksForLayout(
  ...
  return PAGE_LAYOUTS[layoutId].sections
    ...
    .map((section) => ({
      ...
      hint: "Shared global content — page Live toggles stay in Optional sections",
    }));
}
