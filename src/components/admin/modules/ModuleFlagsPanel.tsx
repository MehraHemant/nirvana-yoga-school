...
const FLAG_ITEMS: { key: keyof ModuleFlags; label: string; section: string }[] =
  [
    { key: "showExam", label: "Exam & Certification", section: "8" },
    { key: "showAccommodation", label: "Accommodation & Food", section: "9" },
    { key: "showWhyNirvana", label: "Why Nirvana", section: "11" },
    { key: "showTravel", label: "Travel Guide", section: "12" },
    { key: "showInstagram", label: "Instagram Feed", section: "13" },
    { key: "showMap", label: "Map Section", section: "" },
  ];

/**
 * Toggle panel for optional static page sections.
 *
...
export function ModuleFlagsPanel({
  ...
  return (
    <CollapsiblePanel
      ...
      subtitle="Show or hide on the live page"
