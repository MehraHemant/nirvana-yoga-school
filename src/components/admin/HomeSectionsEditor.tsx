...
export function HomeSectionsEditor({
  ...
  const jumpItems = useMemo(() => {
    return HOME_JUMP_DEFS.map((def) => {
      const section =
        def.key === "meta" ? doc.meta : doc[def.key as keyof HomePageContent];
      return {
  ...
  /** Resolves panel DOM id for a home jump-nav slug. */
  function panelId(slug: (typeof HOME_JUMP_DEFS)[number]["slug"]): string {
    const def = HOME_JUMP_DEFS.find((d) => d.slug === slug);
  ...
  return (
    <div className="admin-editor admin-home-editor">
      ...
      >
        ...
        <div className="admin-nested-list">
          ...
          {doc.welcome.images.map((image, index) => (
            <div key={welcomeImageKeys.keys[index]} className="admin-nested-card">
              <div className="admin-grid-2">
                <ImageField
                  label="Image"
                  value={image.src}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setDoc({
                    ...
                    welcome: {
                      ...doc.welcome,
                      images: doc.welcome.images.filter((_, i) => i !== index),
                    },
                  });
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setDoc({
                    ...
                    gallery: {
                      ...doc.gallery,
                      items: doc.gallery.items.filter((_, i) => i !== index),
                    },
                  });
                }}
              >
            ...
            <TextField
              ...
              onChange={(speakerTag) =>
                setDoc({
                  ...
                  whyRishikesh: {
                    ...doc.whyRishikesh,
                    videoCard: { ...doc.whyRishikesh.videoCard, speakerTag },
                  },
                })
              }
            />
        ...
        <div className="admin-nested-list">
          <div className="admin-nested-list-head">
            ...
            <button
              ...
              onClick={() => {
                logoKeys.addKey();
                const blank: HomeWhyRishikeshTrustLogo = { src: "", alt: "" };
                setDoc({
                  ...doc,
                  whyRishikesh: {
                    ...doc.whyRishikesh,
        ...
        <div className="admin-nested-list">
          <div className="admin-nested-list-head">
            ...
            <button
              ...
              onClick={() => {
                sutraKeys.addKey();
                const blank: HomeWhyRishikeshSutra = { title: "", body: "" };
                setDoc({
                  ...doc,
                  whyRishikesh: {
                    ...doc.whyRishikesh,
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setDoc({
                    ...
                    courses: {
                      ...doc.courses,
                      cards: doc.courses.cards.filter((_, i) => i !== index),
                    },
                  });
                }}
              >
      ...
      <CollapsiblePanel
        ...
        actions={
          <SectionLiveField
            ...
            onChange={(live) =>
              setDoc({ ...doc, yogaAlliance: { ...doc.yogaAlliance, live } })}
          />
        }
      >
        <SectionIdField
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setDoc({
                    ...
                    yogaAlliance: {
                      ...doc.yogaAlliance,
                      certifications: doc.yogaAlliance.certifications.filter(
                        (_, i) => i !== index,
                      ),
                    },
                  });
              ...
              <TextField
                ...
                onChange={(iconKey) => {
                  ...
                  certifications[index] = {
                    ...cert,
                    iconKey: iconKey as HomeYogaAllianceCertification["iconKey"],
                  };
                  setDoc({
                    ...doc,
                    yogaAlliance: { ...doc.yogaAlliance, certifications },
      ...
      >
        ...
        />
        <p className="admin-hint">
          <Link href="/admin/sections/shared#siteMap" className="admin-link">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setDoc({
                          ...
                          faqs: {
                            ...doc.faqs,
                            faqs: doc.faqs.faqs.filter((_, i) => i !== index),
                          },
                        });
                      }}
                    >
        ...
        <div className="admin-grid-2">
          <TextField
            ...
            onChange={(primaryLabel) =>
              setDoc({ ...doc, finalCta: { ...doc.finalCta, primaryLabel } })
            }
          />
          <TextField
        ...
        <div className="admin-grid-2">
          <TextField
            ...
            onChange={(secondaryLabel) =>
              setDoc({ ...doc, finalCta: { ...doc.finalCta, secondaryLabel } })
            }
          />
          <TextField
            ...
            onChange={(secondaryHref) =>
              setDoc({ ...doc, finalCta: { ...doc.finalCta, secondaryHref } })
            }
          />
        </div>
        <div className="admin-grid-2">
